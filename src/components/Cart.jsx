                      ...
                      <div className="mt-6">
                        {isAuthenticated ? (
                          ...
                          <div className="flex justify-center">
                            <LoginButton style="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700" />
                          </div>
                        )}
                      </div>
